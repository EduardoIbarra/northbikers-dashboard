  ...
  return (
    <div className="hidden lg:flex relative">
      <button
        ...
        className="btn btn-default bg-transparent hover:bg-blue-50 text-blue-500 hover:text-blue-600 btn-raised  mr-3 text-center px-6  border rounded cursor-pointer">
        {title}
      </button>
